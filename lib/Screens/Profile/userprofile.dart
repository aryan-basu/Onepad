...
class ProfilePage extends StatelessWidget {
  static final String path = "lib/Screens/Profile/userprofile.dart";
                      ...
                      ...ListTile.divideTiles(
                        ...
                        tiles: [
                          ...
                          ListTile(
                            ...
                            title: Text("Email"),
                            subtitle: Text("anjali557@gmail.com"),
                          ),
                          ListTile(
                            leading: Icon(Icons.phone),
                            title: Text("Phone"),
                            subtitle: Text("97--97986-71"),
                          ),
                          ListTile(
                            leading: Icon(Icons.person),
                            title: Text("Status/About"),
                            subtitle: Text(
                                "This is a about me section and you can set your status or description here accordingly."),
                          ),
                        ],
                      ),
                    ],
