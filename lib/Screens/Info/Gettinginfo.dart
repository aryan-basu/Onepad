        ...
        onWillPop: () async {
          ...
          await showDialog(
              ...
              builder: (_) => AlertDialog(
                    title: Helper.text(
                        'Are you sure want to skip the profile section? You won\'t be able to update it later!!!',
                        15,
                        0),
                    actions: [
                      ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (b) => SplashScreen()));
                          },
                          child: Helper.text('YES', 15, 0)),
                      TextButton(
                          onPressed: () => Navigator.of(context).pop(),
                          child: Helper.text('NO', 15, 0))
                    ],
                  ));
          return willLeave;
        },
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Helper.subtext("Set up your profile", 18, 0),
                      ],
                    ),
                  ),
                  SizedBox(
